<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="ACI02_Form.aspx.cs" Inherits="ACI02_Form" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            ...
            <td>
                ...
                <PC:DropDownList ID="ddlSectionCode" runat="server" CssClass="TextBoxForm" Width="480px" RegisterClientVariable="true">
                </PC:DropDownList>
                </td>
    ...
    <script language="javascript">
       ...
       /*
            ...
            var project = "-2";
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=ACI01&Proj=" + project;             
