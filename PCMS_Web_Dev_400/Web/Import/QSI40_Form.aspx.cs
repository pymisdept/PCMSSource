...
public partial class QSI40_Form : BasePage
{
    ...
    void Master_Save(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                // Modified by Ken, 20161115, begin
                exceedLimit = UpdateLoad.UploadFile.Count > Config.BatchPRUploadLimit;
                limit = exceedLimit ? Config.BatchPRUploadLimit : UpdateLoad.UploadFile.Count;
                ...
                {
                    isErr = true;
                    errMsg = "* " + string.Format(Resources.Messages.ExceedBatchUploadLimit, Config.BatchPRUploadLimit) + "\\n";
                }
