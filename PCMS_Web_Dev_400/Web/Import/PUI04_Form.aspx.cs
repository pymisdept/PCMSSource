...
public partial class PUI04_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        // PAList by Project Code if exists
        /*if (ddlProject.SelectedValue != "")
        {
            PCCore.Database.ValidationList.PACodeList(ddlPA, ddlProject.SelectedValue);
        }
        else
        {
            PCCore.Database.ValidationList.PACodeList(ddlPA);
        }*/
        ...
        else
        {
            ...
            ddlPA.Items.Add(new ListItem(Resources.Labels.NA, Resources.Labels.NA.ToString()));
            ddlPA.Enabled = false;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI04,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveFiles(Convert.ToDecimal(row["ID"]),Table.InternalCommand);
                    this.Table.CommitTransaction();
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI04, ddlProject.SelectedValue, true); 
    ...
    {
        // PAList by Project Code if exists
        if (ddlProject.SelectedValue != "" && ddlProject.SelectedValue != "-2" && ddlProject.SelectedValue != "-1")
        {
            ddlPA.Items.Clear();
            ddlPA.Enabled = true;
            PCCore.Database.ValidationList.PACodeList(ddlPA, ddlProject.SelectedValue,"CO");
        }
        else
        {
            ddlPA.Items.Clear();
