...
public partial class QSI19_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI19;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI19,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI19,ddlProject.SelectedValue,true);
