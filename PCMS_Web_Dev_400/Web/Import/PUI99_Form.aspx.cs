...
public partial class PUI99_Form : BasePage
{
    ...
    Hashtable GetRow()
    {
        ...
        {
            row.Add("DOCSTATUS", "UP"); // Update-Pending
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI01,ddlProject.SelectedValue);
