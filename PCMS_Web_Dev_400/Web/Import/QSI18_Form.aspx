<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="QSI18_Form.aspx.cs" Inherits="QSI18_Form" %>
 ...
 %>
    ...
    <script language="javascript">
    	...
    	function downloadTemplate()
        {
            ...
            var subcontidx = ddlSubCont.selectedIndex;
            var subcont = ddlsubCont.option[subcontidx].value;
            
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=QSI18&Proj=" + project + "&SubContractor=" + subcontractor + "&SubCont=" + subcont;             
