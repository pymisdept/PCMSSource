...
public partial class QSI30_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI30;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                ...
                case MasterForm.FormModes.New:
                    ...
                    /* Remove project code lookup */
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI30,ddlProject.SelectedValue);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI30, "-2");
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI30,ddlProject.SelectedValue,true);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI30, "-2", true);
