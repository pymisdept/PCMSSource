<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="PUI04_Form.aspx.cs" Inherits="PUI04_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label4" runat="server" width="70px"
                        Text="<%$ Resources:Labels,Project %>" />
            </td>
            <td>
                :
            </td>
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label1" runat="server" Width="90px" Text="<%$ Resources:Labels,BaseNo %>" />
            </td>
            <td>
                :
            </td>
            <td>
                    <PC:DropDownList ID="ddlPA" runat="server" CssClass="TextBoxForm" Width="480px" 
                        RegisterClientVariable="true" onselectedindexchanged="ddlPA_SelectedIndexChanged">
                    </PC:DropDownList>
            </td>
        </tr>
        <%--
        <tr>
            <td><asp:Button ID="btnDownload" runat="server" Text="<%$ Resources:Common,Download %>" 
                OnClientClick="javascript:if(!downloadTemplate()) return false;"
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            var projValue = ddlProject.options[projindex].value;
             var paindex = ddlPA.selectedIndex;
            var paValue = ddlPA.options[paindex].value;
                       
               _RequestStr = UpAllDownoLoadFileUrl+"?Func=PUI04&Proj=" + projValue + "&pacode=" + paValue;             
