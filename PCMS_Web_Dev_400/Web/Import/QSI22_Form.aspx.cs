...
public partial class QSI22_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI22;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI22,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI22,ddlProject.SelectedValue,true);
