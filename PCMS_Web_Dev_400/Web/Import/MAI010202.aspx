<%@ Page Language="C#" MasterPageFile="~/Control/MasterCustomize.master" AutoEventWireup="true"
    CodeFile="MAI010202.aspx.cs" Inherits="MAI010202" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td height="5px" colspan="10">
                <PC:Label ID="lblDesc"  Font-Bold="true" runat="server" Text="<%$ Resources:Labels,MAI010202DESC %>" />
            </td>
        </tr>   
        
        <tr>
            <td height="5px" colspan="10">
                <PC:TextBox id="txtValue" width="100%" TextMode="MultiLine" rows="10" cols="800" runat="server"></PC:TextBox> 
            </td>
        </tr>   
