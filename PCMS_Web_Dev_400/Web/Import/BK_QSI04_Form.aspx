<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="BK_QSI04_Form.aspx.cs" Inherits="QSI04_Form" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label5" runat="server" Text="<%$ Resources:Labels,Project %>" />
            </td>
            <td>
                :
            </td>
            <td>
                ...
                <td width="60%"><PC:DropDownList ID="ddlProject" runat="server" 
                        ...
                        onselectedindexchanged="ddlProject_SelectedIndexChanged" AutoPostBack="false">
                </PC:DropDownList></td>
            ...
            <td>
                ...
                <tr>
                   <td width="60%"><PC:DropDownList ID="ddlSubcontractor" runat="server" 
                        CssClass="TextBoxForm" Width="480px" RegisterClientVariable="true" 
                        onselectedindexchanged="ddlSubcontractor_SelectedIndexChanged" AutoPostBack="false">
                </PC:DropDownList></td>
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            var subcontractor = ddlSubcontractor.options[subcontractoridx].value
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=QSI04&Proj=" + project + "&SubContractor=" + subcontractor;             
