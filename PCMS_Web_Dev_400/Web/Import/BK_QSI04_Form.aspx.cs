...
public partial class QSI04_Form : BasePage
{
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI04,ddlProject.SelectedValue);
    ...
    {
        if (ddlProject.SelectedValue.ToString() != "-2")
        {
