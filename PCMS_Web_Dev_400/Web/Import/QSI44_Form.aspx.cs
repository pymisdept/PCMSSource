...
public partial class QSI44_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI44;
    ...
    private void setData()
    {
        ...
        PCCore.Database.ValidationList.CustomerList(ddlCusomter, Consts.DropDownOptionNone);
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI44,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI44,ddlProject.SelectedValue,true);
