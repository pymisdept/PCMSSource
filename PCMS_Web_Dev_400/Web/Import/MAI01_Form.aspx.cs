...
public partial class MAI01_Form : BasePage
{
    ...
    void Master_Save(object sender, EventArgs e)
    {
        ...
        if (txtcutoff.Text.Trim() == "")
        {
            Master.ShowMessage("Please input cut-off date!");
            return;
        }
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.MAI01,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    //(byada)UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI02,ddlProject.SelectedValue,true);
