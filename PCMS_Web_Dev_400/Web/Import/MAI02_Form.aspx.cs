...
public partial class MAI02_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.MAI02;
        ...
        else
        {
            ...
            PCCore.Database.ValidationList.QSSectionList(ddlSectionCode, Consts.DropDownOptionNone);
        }
    }
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                ...
                case MasterForm.FormModes.New:
                    ...
                    /* Remove project code lookup */
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.MAI02,ddlProject.SelectedValue);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.MAI02, "-2");
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.MAI02,ddlProject.SelectedValue,true);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.MAI02, "-2", true);
