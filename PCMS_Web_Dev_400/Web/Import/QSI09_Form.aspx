<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="QSI09_Form.aspx.cs" Inherits="QSI09_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            ...
            <td>
                ...
                <td width="60%"><PC:DropDownList ID="ddlProject" runat="server"  
                        AutoPostBack="true" CssClass="TextBoxForm" Width="430px" 
                        RegisterClientVariable="true" 
        ...
        <tr>
            ...
            <td>
                ...
                <table>
                <tr>
                <td width="60%"><PC:DropDownList ID="ddlSubContractor" runat="server" CssClass="TextBoxForm" Width="480px" RegisterClientVariable="true">
                </PC:DropDownList></td>
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=QSI09&Proj=" + project + "&SubContractor=" + subcontractor;             
