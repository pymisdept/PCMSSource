<%@ Page Language="C#" MasterPageFile="~/Control/MasterCustomize.master" AutoEventWireup="true"
    CodeFile="MAI010302.aspx.cs" Inherits="MAI010302" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td height="5px" colspan="10">
                ...
                <PC:GridView ID="gvData" AllowPaging="false" runat="server" DataSourceID="dsGridView" SkinID="SecuritySkin"
                     SelectValueField="SEQ" DataKeyNames="SEQ"  SelectedIndex="0" OnDataBound="gvData_DataBound"
                    BorderWidth="0" GridViewStyle="UserDefine" AllowMultipleSelect="False" OnRowDataBound="gvData_RowDataBound"></PC:GridView>    
            </td>
        </tr>  
