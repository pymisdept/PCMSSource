...
public partial class ProjectItemSetup_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.ProjectItemSetup;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    Master.ShowMessage(String.Format(Resources.Common.SaveOK, txtDescription.Text));
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveFiles(Convert.ToDecimal(row["ID"]),Table.InternalCommand);
                    this.Table.CommitTransaction();
                    Master.ShowMessage(String.Format(Resources.Common.UpdateOK, txtDescription.Text));                    
                    break;
            }
        }
        catch (Exception ex)
