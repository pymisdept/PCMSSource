...
public partial class PUI08_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.PUI08;
    ...
    Hashtable GetRow()
    {
        ...
        string tfile = txtFileName.Text;
        if (txtFileName.Text == "")
            tfile = UpdateLoad.UploadFile[0].FileName.ToString();

        row.Add("FILENAME", tfile);
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                ...
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI08,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI08,ddlProject.SelectedValue,true);
