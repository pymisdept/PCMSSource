...
public partial class PUI06_Form : BasePage
{
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                ...
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI06,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.PUI06,ddlProject.SelectedValue,true);
    ...
    protected void ddlProject_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlProject.SelectedValue != "" && ddlProject.SelectedValue != "-2" && ddlProject.SelectedValue != "-1")
        {
            ddlPA.Items.Clear();
            ddlPA.Enabled = true;
            PCCore.Database.ValidationList.PACodeList(ddlPA, ddlProject.SelectedValue, "GR");
        }
        else
        {
            ddlPA.Items.Clear();
