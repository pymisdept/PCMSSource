...
public partial class MAI01030301 : BasePage
{
    const string TABLE_NAME = "DocumentProperty";
    const string FILE_TYPE = "4001331";
    ...
    string dtControlName = PCCore.PCMS.PMReportTable.PMR_DiffReason;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            txtValue1.Enabled = viewmode;
            txtValue2.Enabled = viewmode;
            txtValue3.Enabled = viewmode;
    ...
    private void Save()
    {
        ...
        if (_htControl.Count < 2)
            PCCore.PCMS.PMReportTable.EmptyRow(ref _htControl, PCCore.PCMS.PMReportTable.SE_HT_FIELDS_PMR_ScopeOfWorks, "2");
        if (_htControl.Count < 3)
            PCCore.PCMS.PMReportTable.EmptyRow(ref _htControl, PCCore.PCMS.PMReportTable.SE_HT_FIELDS_PMR_ScopeOfWorks, "3");
