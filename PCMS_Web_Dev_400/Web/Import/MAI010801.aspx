<%@ Page Language="C#" MasterPageFile="~/Control/MasterCustomize.master" AutoEventWireup="true"
    CodeFile="MAI010801.aspx.cs" Inherits="MAI010801" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <td width="100%">
            <table width="100%">
            <td  align="left">
               <PC:Label id="Label1" runat="server" Text="<%$ Resources:Labels,Project %>"></PC:Label>
            </td >
            <td >
                <PC:Label ID="txtProject" runat="server" Text=""></PC:Label>
            </td>
            <td  align="left">
        ...
        <tr>
            <td height="5px" colspan="10">
                <PC:GridView ID="gvData" AllowPaging="false" runat="server" SkinID="SecuritySkin"
                     SelectValueField="linenum" DataKeyNames="linenum"  SelectedIndex="0" 
                    BorderWidth="0" OnRowCommand="gvData_Command" GridViewStyle="UserDefine" AllowMultipleSelect="False" OnRowDataBound="gvData_RowDataBound"></PC:GridView> 
        ...
        <tr>
        <td width="20%">
            <PC:Label ID="LabelUpload" Text="<%$ Resources:Labels,FileName %>" Font-Bold="true" runat="server"></PC:Label>
        </td>
        <td width="5%"><b>:</b></td>
        <td>
            <asp:FileUpload ID="uploadImg" runat="server" Width="390px" />
        </td>
        
        </tr>          
        <tr>
        <td width="20%">
            <PC:Label ID="LabelDesc" Text="<%$ Resources:Labels,Description %>" Font-Bold="true" runat="server"></PC:Label>
        </td>
        <td width="5%"><b>:</b></td>
        <td >
            <PC:TextBox ID="txtDesc" width="96%" TextMode="MultiLine" Rows = "4" 
                runat="server"></PC:TextBox>
        </td>
        </tr>
        <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>
        <asp:Button id="btnSumbit" Text="<%$ Resources:Labels,Add %>" EnableViewState="true"  runat="server" 
                onclick="btnSumbit_Click" Width="120px"></asp:Button>
        </td>
        </tr>
        </table>
        </td>
