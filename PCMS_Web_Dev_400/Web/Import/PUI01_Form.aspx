<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="PUI01_Form.aspx.cs" Inherits="PUI01_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label1" runat="server" width = "70px" Text="<%$ Resources:Labels,Project %>" />
            </td>
            <td>
                :
            </td>
            ...
            <td>
                <PC:DropDownList ID="ddlProject" runat="server" CssClass="TextBoxForm" 
                    Width="430px" RegisterClientVariable="true"></PC:DropDownList>
