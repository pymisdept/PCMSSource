...
public partial class MAI010301 : BasePage
{
    const string TABLE_NAME = "DocumentProperty";
    const string FILE_TYPE = "4001301";
    ...
    private void setData()
    {
        ...
        dsGridView.SelectCommand = "SELECT SEQ,NAME,':',ISNULL(LastMonth,0) as [Last Month],ISNULL(ThisMonth,0) as [This Month],ISNULL(NextMonth,0) as [Next Month] FROM [$PaymentApp]";
