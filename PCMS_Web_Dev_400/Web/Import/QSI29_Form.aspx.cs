...
public partial class QSI29_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI29;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                ...
                case MasterForm.FormModes.New:
                    ...
                    /* Remove project code lookup */
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI29,ddlProject.SelectedValue);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI29, "-2");
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    /*
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI29,ddlProject.SelectedValue,true);
                    */
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI29, "-2", true);
