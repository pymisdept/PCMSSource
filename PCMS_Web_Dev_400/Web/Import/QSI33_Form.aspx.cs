...
public partial class QSI33_Form : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)    
    {
        ...
        Master.Title = Resources.Labels.QSI33;
        ...
        try
        {
            ...
            switch (Master.FormMode)
            {
                case MasterForm.FormModes.New:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI33,ddlProject.SelectedValue);
                ...
                case MasterForm.FormModes.Edit:
                    ...
                    UpdateLoad.SaveToFile(Convert.ToDecimal(row["ID"]), Table.InternalCommand, Resources.TemplateInfo.QSI33,ddlProject.SelectedValue,true);
