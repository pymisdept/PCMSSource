<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="PUI06_Form.aspx.cs" Inherits="PUI06_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label1" runat="server" width="90px" Text="<%$ Resources:Labels,Project %>" />
            </td>
            <td>
                :
            </td>
            <td>
               <PC:DropDownList ID="ddlProject" runat="server" CssClass="TextBoxForm" Width="430px" 
                    RegisterClientVariable="true" AutoPostBack="true"
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label4" runat="server" Text="<%$ Resources:Labels,BaseNo %>" />
            </td>
            <td>
                :
            </td>
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=PUI01&Proj=" + project;             
