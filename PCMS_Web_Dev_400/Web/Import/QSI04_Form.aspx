<%@ Page Language="C#" MasterPageFile="~/Control/MasterFormMUpl.master" AutoEventWireup="true"
    CodeFile="QSI04_Form.aspx.cs" Inherits="QSI04_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
           ...
           <td width="85%">
                ...
                </PC:DropDownList></td><td><PC:ImageButton ID="ibProject" runat="server" ImageUrl="<%=themeUrl %>/images/search.gif" OnClientClick="javascript:SearchProject()" /></td>
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=QSI04&Proj=" + project;             
