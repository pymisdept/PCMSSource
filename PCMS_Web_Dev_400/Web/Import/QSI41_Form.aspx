<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="QSI41_Form.aspx.cs" Inherits="QSI41_Form" %>
...
<%
 ...
 %>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            ...
            <td>
                ...
                <td width="60%"><PC:DropDownList ID="ddlProject" runat="server" 
                        CssClass="TextBoxForm" Width="450px" RegisterClientVariable="true" 
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label4" runat="server" Text="<%$ Resources:Labels,SubContractor %>" />
            </td>
            <td>
                :
            </td>
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label5" runat="server" Text="<%$ Resources:Labels,SubContractNo %>" />
            </td>
            <td>
                :
            </td>
            <td>
                ...
                <table>
                <tr>
                <td width="60%"><PC:DropDownList ID="ddlSubCont" runat="server" CssClass="TextBoxForm" Width="480px" RegisterClientVariable="true">
                </PC:DropDownList></td>
                <td width="40%"><asp:Button ID="btnDownload" Visible="false" runat="server" Text="<%$ Resources:Common,Download %>" OnClientClick="javascript:if(!downloadTemplate()) return false;"
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=QSI41&Proj=" + project;             
