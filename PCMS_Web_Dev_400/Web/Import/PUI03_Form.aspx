<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="PUI03_Form.aspx.cs" Inherits="PUI03_Form" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <%-- //remove base document selection --%>
        <%-- //start
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label5" runat="server" 
                    Text="<%$ Resources:Labels,InputType %>" Width="70px"/>
            </td>
            <td>
                :
            </td>
        ...
        <tr>
            <td>
                ...
                <PC:Label LabelStyle="xLabel" ID="Label4" runat="server" Width ="90px" Text="<%$ Resources:Labels,BaseNo %>" />
            </td>
            <td>
              :  
            </td>
    ...
    <script language="javascript">
       ...
       _RequestStr = UpAllDownoLoadFileUrl+"?Func=PUI03&Proj=" + project;             
