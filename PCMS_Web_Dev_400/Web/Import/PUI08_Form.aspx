<%@ Page Language="C#" MasterPageFile="~/Control/MasterForm.master" AutoEventWireup="true"
    CodeFile="PUI08_Form.aspx.cs" Inherits="PUI08_Form" %>
...
%>
        ...
        <tr>
            ...
            <td>
               <PC:DropDownList ID="ddlProject" runat="server" CssClass="TextBoxForm" Width="430px" 
                    RegisterClientVariable="true" AutoPostBack="true" ></PC:DropDownList>
    ...
    <script language="javascript">
       ...
       // alert("test");
            ...
            _RequestStr = UpAllDownoLoadFileUrl+"?Func=PUI08&Proj=" + project;             
