...
public partial class Control_PU06ExportExcel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            sqlstr += "ponum as [PO No.], CardName as [Supplier Name], [Description], Unit, Quantity as Qty, rate as [Unit Rate], polinetotal as [Total], ";
            ...
            ws.Cells[1, 1] = "MATERIAL ORDER LIST - with SMR (in HK$)";
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                try
                {
                    ...
                    ws.get_Range(ws.Cells[CurRow, TotalCol], ws.Cells[CurRow, TotalCol]).Formula = "=+SUM(L" + StartDataRow + ":L" + LastDataRow + ")";
                    ...
                    ws.get_Range(ws.Cells[CurRow, InvAmtCol], ws.Cells[CurRow, InvAmtCol]).Formula = "=+SUM(N" + StartDataRow + ":N" + LastDataRow + ")";
                    ...
                    ((Range)ws.Cells[CurRow, TotalCol - 1]).HorizontalAlignment = XlHAlign.xlHAlignRight;
                    ws.get_Range(ws.Cells[CurRow, TotalCol], ws.Cells[CurRow, TotalCol]).Formula = "=+SUBTOTAL(9,L" + StartDataRow + ":L" + LastDataRow + ")";
                    ((Range)ws.Cells[CurRow, TotalCol]).Borders.get_Item(XlBordersIndex.xlEdgeTop).LineStyle = XlLineStyle.xlContinuous;
                    ((Range)ws.Cells[CurRow, TotalCol]).Borders.get_Item(XlBordersIndex.xlEdgeBottom).LineStyle = XlLineStyle.xlContinuous;
                    ws.get_Range(ws.Cells[CurRow, InvAmtCol], ws.Cells[CurRow, InvAmtCol]).Formula = "=+SUBTOTAL(9,N" + StartDataRow + ":N" + LastDataRow + ")";
                    ((Range)ws.Cells[CurRow, InvAmtCol]).Borders.get_Item(XlBordersIndex.xlEdgeTop).LineStyle = XlLineStyle.xlContinuous;
                    ...
                    for (int i = 1; i < dt.Rows.Count + 1; i++)
                    {
                        ...
                        ws.get_Range(ws.Cells[CurRow, TotalCol], ws.Cells[CurRow, TotalCol]).Formula = "=+SUMIF(Q$" + StartDataRow + ":Q$" + LastDataRow + ",Q"+CurRow+",L$"+StartDataRow+":L$"+LastDataRow+ ")";
                        ws.get_Range(ws.Cells[CurRow, InvAmtCol], ws.Cells[CurRow, InvAmtCol]).Formula = "=+SUMIF(Q$" + StartDataRow + ":Q$" + LastDataRow + ",Q" + CurRow + ",N$" + StartDataRow + ":N$" + LastDataRow + ")";
                        CurRow++;
                    }
                    CCSummaryTotRow = CurRow + 1;
                    ws.get_Range(ws.Cells[CurRow+1, TotalCol], ws.Cells[CurRow+1, TotalCol]).Formula = "=+SUM(L" + CCSummaryStartRow + ":L" + CurRow + ")";
                    ...
                    ws.get_Range(ws.Cells[CurRow+1, InvAmtCol], ws.Cells[CurRow+1, InvAmtCol]).Formula = "=+SUM(N" + CCSummaryStartRow + ":N" + CurRow + ")";
                    ...
                    CurRow = CurRow + 3;
                    ws.get_Range(ws.Cells[CurRow, TotalCol], ws.Cells[CurRow, TotalCol]).Formula = "=+L" + CCSummaryTotRow + "-L" + GrandTotRow;
                    ws.get_Range(ws.Cells[CurRow, InvAmtCol], ws.Cells[CurRow, InvAmtCol]).Formula = "=+N" + CCSummaryTotRow + "-N" + GrandTotRow;
                    ...
                    ((Range)ws.Cells[1, 12]).EntireColumn.NumberFormat = "#,##0.00";
                    ((Range)ws.Cells[1, 13]).EntireColumn.HorizontalAlignment = XlHAlign.xlHAlignLeft;
                    ((Range)ws.Cells[1, 14]).EntireColumn.HorizontalAlignment = XlHAlign.xlHAlignRight;
                    ((Range)ws.Cells[1, 14]).EntireColumn.NumberFormat = "#,##0.00";
                    ...
                    //set column width
                    ((Range)ws.Cells[1, 1]).EntireColumn.ColumnWidth = 12;
                    ((Range)ws.Cells[1, 2]).EntireColumn.ColumnWidth = 0.38;
                    ((Range)ws.Cells[1, 3]).EntireColumn.ColumnWidth = 7;
                    ((Range)ws.Cells[1, 4]).EntireColumn.ColumnWidth = 0.38;
                    ((Range)ws.Cells[1, 5]).EntireColumn.ColumnWidth = 13;
                    ((Range)ws.Cells[1, 6]).EntireColumn.ColumnWidth = 18;
                    ((Range)ws.Cells[1, 7]).EntireColumn.ColumnWidth = 26;
                    ((Range)ws.Cells[1, 8]).EntireColumn.ColumnWidth = 30;
                    ((Range)ws.Cells[1, 9]).EntireColumn.ColumnWidth = 8;
                    ((Range)ws.Cells[1, 10]).EntireColumn.ColumnWidth = 8;
                    ((Range)ws.Cells[1, 11]).EntireColumn.ColumnWidth = 12;
                    ((Range)ws.Cells[1, 12]).EntireColumn.ColumnWidth = 16;
                    ((Range)ws.Cells[1, 13]).EntireColumn.ColumnWidth = 16;
                    ((Range)ws.Cells[1, 14]).EntireColumn.ColumnWidth = 16;
                    ((Range)ws.Cells[1, 15]).EntireColumn.ColumnWidth = 9;
                    ((Range)ws.Cells[1, 16]).EntireColumn.ColumnWidth = 8;
                    ((Range)ws.Cells[1, 17]).EntireColumn.ColumnWidth = 12;
                    ((Range)ws.Cells[1, 18]).EntireColumn.ColumnWidth = 15;
