...
public partial class Control_MA03ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string division = Request.QueryString["SDCode"].ToString();

        ReportDocument objRpt = new ReportDocument();
        string reportPath = ConfigurationManager.AppSettings["MA03CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(0, docDate);
        objRpt.SetParameterValue(1, division);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA03_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
