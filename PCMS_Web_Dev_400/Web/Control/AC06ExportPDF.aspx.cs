...
public partial class Control_AC06ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["AC06CrystalReportPath"].ToString();
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "AC06_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
