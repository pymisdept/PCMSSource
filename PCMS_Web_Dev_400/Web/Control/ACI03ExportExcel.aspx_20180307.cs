    ...
    protected void ExportButton_Click(object sender, EventArgs e)
    {
           ...
           )
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    try
                    {
                        ...
                        TempStoreStr = TempStoreStr + "Group_CostType			nvarchar(5), ";
                        TempStoreStr = TempStoreStr + "Group_CostTypeDesc		nvarchar(200), ";
                        TempStoreStr = TempStoreStr + "Group_ReportCode		    nvarchar(5), ";
                        TempStoreStr = TempStoreStr + "Group_ReportCodeName	    nvarchar(200), ";
                        TempStoreStr = TempStoreStr + "Group_amount			    numeric(19,6), ";
                        ...
                        */
                        ...
                        TempStoreStr = "select z.SortLevel1, z.PrjCode, z.PrjName, z.CostCode, z.CostCodeDesc, z.U_ReportCode, z.CostType, z.CostTypeDesc, z.TrxDate, z.TrxType, z.Ref, z.BatchNo, z.VoucherNo, z.amount, z.AC_PERIOD, z.orderitem, z.TransType, z.Group_CostType, z.Group_CostTypeDesc, z.Group_ReportCode, z.Group_ReportCodeName, z.Group_amount ";
                        TempStoreStr = TempStoreStr + "from (  ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, TrxDate, TrxType, Ref, BatchNo, VoucherNo, amount, AC_PERIOD, 1 as orderitem, TransType, Group_CostType, Group_CostTypeDesc, Group_ReportCode, Group_ReportCodeName, Group_amount ";
                        TempStoreStr = TempStoreStr + "FROM #TR_Rpt ";
                        TempStoreStr = TempStoreStr + "union all ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, '' as TrxDate, '' as TrxType, '' as Ref, '' as BatchNo, '' as VoucherNo, sum(amount), '' as AC_PERIOD, 2 as orderitem, '' as TransType, '' as Group_CostType, '' as Group_CostTypeDesc, '' as Group_ReportCode, '' as Group_ReportCodeName, 0 as Group_amount ";
          ...
          AC_PERIOD
                                ...
                                if (datareader.HasRows == true)
                                {
                                    if (StartRow == true)
                                    {
                                        ...
                                        for (int i = 0; i < datareader.FieldCount; i++)
                                        {
                                            ...
                                            Excel.Border border5 = oSheet.get_Range("A" + intRow.ToString(), "L" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                            border5.LineStyle = Excel.XlLineStyle.xlContinuous;
                                            //***********************
                                        }
                                        oSheet.get_Range("A" + intRow.ToString(), "L" + intRow.ToString()).Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Blue);
                                        intRow = intRow + 1;
                                    }
                                        ...
                                        if (datareader["SortLevel1"].ToString() == "4")
                                        {
                                            ...
                                            if (datareader["Group_amount"] != System.DBNull.Value)
                                            {
                                                ...
                                                if (datareader["Group_ReportCode"].ToString() != "CC")
                                                    ...
                                                    oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=+SUMIF($D$5:$D$" + BeforeTotalRow.ToString() + ",C" + intRow.ToString() + ",$K$5:$K$" + BeforeTotalRow.ToString() + ")";
                        ...
                        oRng = oSheet.get_Range("A1", "L65536");
