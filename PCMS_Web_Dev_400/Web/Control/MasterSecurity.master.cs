...
public partial class MasterSecurity : MasterBasePage, IErrorHandler
{
    // Report Useful
    public string _ProjectCode1;
    public string _ProjectCode2;

    public string ProjectCode1
    {
        set
        {
            _ProjectCode1 = value;
    ...
    {
        // Test by Karrson
        //if (SessionInfo.RedirectUrl != String.Empty)
        //{
        //    string _redirectUrl = SessionInfo.RedirectUrl;
        //    SessionInfo.RedirectUrl = String.Empty;
