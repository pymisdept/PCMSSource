        ...
        if (!Page.IsPostBack)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                try
                {
                    ...
                    ((Range)ws.Cells[1, 3]).EntireColumn.ColumnWidth = 5.5;
                    ((Range)ws.Cells[1, 4]).EntireColumn.ColumnWidth = 0.4;
                    ...
                    ((Range)ws.Cells[1, 8]).EntireColumn.ColumnWidth = 0.4;
                    ((Range)ws.Cells[1, 9]).EntireColumn.ColumnWidth = 30;
                    ((Range)ws.Cells[1, 10]).EntireColumn.ColumnWidth = 7;
                    ((Range)ws.Cells[1, 11]).EntireColumn.ColumnWidth = 8;
