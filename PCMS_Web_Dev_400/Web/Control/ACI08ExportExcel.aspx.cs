            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    try
                    {
                        ...
                        SqlCommand command = new SqlCommand("sp_AC03_Detail_Cost_Summary_New", connection);
                        ...
                        oSheet.Cells[Project_Row, 11] = "Base Currency: ";
                                ...
                                if (datareader.HasRows == true)
                                {
                                    if (StartRow == true)
                                    {
                                        ...
                                        for (int i = 0; i < datareader.FieldCount; i++)
                                        {
                                            ...
                                            {
                                                oSheet.Cells[Project_Row, 11] = "Base Currency: " + datareader["DocCur"].ToString();
                                            }
