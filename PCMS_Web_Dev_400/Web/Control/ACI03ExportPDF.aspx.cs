...
public partial class Control_ACI03ExportPDF : System.Web.UI.Page
{
    ...
    protected void ExportButton_Click(object sender, EventArgs e)
    {
            ...
            )
        {
            ...
            string reportPath = ConfigurationManager.AppSettings["ACI03CrystalReportPath"].ToString();
            ...
            objRpt.SetParameterValue(0, CostCodeFr.Text);
            objRpt.SetParameterValue(1, CostCodeTo.Text);
            objRpt.SetParameterValue(2, Convert.ToInt32(PrdChoice.Text));
            objRpt.SetParameterValue(3, PeriodFr.Text);
            objRpt.SetParameterValue(4, PeriodTo.Text);
            objRpt.SetParameterValue(5, TransType.Text);
            objRpt.SetParameterValue(6, Request.QueryString["UserID"].ToString().Replace("?mode=New", "").Replace("?mode=New&", "").Replace("?mode=", ""));
            objRpt.SetParameterValue(7, projValue.Replace("?mode=New", "").Replace("?mode=New&", "").Replace("?mode=", ""));
