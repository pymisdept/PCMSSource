...
public partial class MasterProjectReport : MasterBasePage, IErrorHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SessionInfo.CurrentFunctionID != "1145" && SessionInfo.CurrentFunctionID != "1148" && SessionInfo.CurrentFunctionID != "3109") 
            PCCore.Database.ValidationList.ReportProjectList(ddlProject, Consts.DropDownOptionNone);
        else if(SessionInfo.CurrentFunctionID == "3109")
        {
                        
            if (SessionInfo.IsSupervisor)
            {
                SAPDb.InitDropDownList(ddltProject, "CPS_View_UserLedgerAll", "CompanyCode", "CompanyName", Consts.DropDownOptionNone, null, null);
                PCCore.Database.ValidationList.ProjectList(ddlProject, Consts.DropDownOptionNone);
            }
            else
            {
                SAPDb.InitDropDownList(ddltProject, "CPS_View_UserLedger", "CompanyCode", "CompanyName", Consts.DropDownOptionNone, null, string.Format(" LOGINNAME =('{0}')", SessionInfo.LoginName.ToUpper()));
                PCCore.Database.ValidationList.UserProjectList(ddlProject, SessionInfo.UserId, Consts.DropDownOptionNone);
            }

            ddlProject.Items.Insert(1, "All");
            ddltProject.Items.Insert(1, "All");
        }
        ...
        if (SessionInfo.CurrentFunctionID == "3104" || SessionInfo.CurrentFunctionID == "3105")
        {
            Label6.Visible = true;
            Label7.Visible = true;
            Label6.Text = "Year End";
            txtcutoff.Visible = true;
            txtcutoff.DataType = SimpleTextBox.DataTypes.String;
        }
        if (SessionInfo.CurrentFunctionID == "1128")
        {
            Label6.Visible = true;
            Label7.Visible = true;
            Label6.Text = "Period";
        ...
        else if (SessionInfo.CurrentFunctionID == "3106" || SessionInfo.CurrentFunctionID == "3107" || SessionInfo.CurrentFunctionID == "4105" || SessionInfo.CurrentFunctionID == "4109" || SessionInfo.CurrentFunctionID == "4110" || SessionInfo.CurrentFunctionID == "4114" || SessionInfo.CurrentFunctionID == "4115")
        {
            Label6.Visible = true;
            Label7.Visible = true;
        ...
        else if (SessionInfo.CurrentFunctionID == "2113")
        {
            Label6.Visible = true;
            Label7.Visible = true;
            txtcutoff.Visible = true;
        }
        else if (SessionInfo.CurrentFunctionID == "4102")
        {
            Label8.Visible = true;
            Label9.Visible = true;
            txtSecDiv.Visible = true;
        }
        else if( SessionInfo.CurrentFunctionID == "4103" || SessionInfo.CurrentFunctionID == "4104")
        {
            Label6.Visible = true;
            Label7.Visible = true;
            Label8.Visible = true;
        ...
        else if (SessionInfo.CurrentFunctionID == "1147")
        {
            Label6.Visible = true;
            Label7.Visible = true;
            Label6.Text = "Due Date";
            txtcutoff.Visible = true;
            txtcutoff2.Visible = true;

            Label10.Visible = true;
        }
        else if(SessionInfo.CurrentFunctionID == "1148")
        {
            lblDepartment.Text = "Cost Code";
            tb_ccFm.Text = "000000";
            tb_ccFm.Visible = true;
            tb_ccTo.Text = "ZZZZZZ";
            tb_ccTo.Visible = true;

            ddlProject.Visible = false;
            ddlProject.Width = 1;
            ibProject.Visible = false;
            Label1.Visible = true;
        }
        else if (SessionInfo.CurrentFunctionID == "3109")
        {
            ...
            lblDepartment.Text = "Project";
            Label2.Text = "Ledger";
            Label6.Text = "Reporting Period";
        }
...
//                SAPDb.InitDropDownList(ddlProject, "CPS_View_ProjectList", "projectcode", "PrjDesc", Consts.DropDownOptionNone, null, null);
        ...
        //add by Martin, begin
        if (SessionInfo.CurrentFunctionID == "3101" || SessionInfo.CurrentFunctionID == "3102" || SessionInfo.CurrentFunctionID == "3103" || SessionInfo.CurrentFunctionID == "3108" || SessionInfo.CurrentFunctionID == "2106" || SessionInfo.CurrentFunctionID == "2107" || SessionInfo.CurrentFunctionID == "1147")
        {
            ExportPDFButton.Visible = true;
            ExportExcelButton.Visible = true;
            //xExcelxls.Visible = false;
        }
        else if ((SessionInfo.CurrentFunctionID == "2109") || (SessionInfo.CurrentFunctionID == "2110") || (SessionInfo.CurrentFunctionID == "2111") || (SessionInfo.CurrentFunctionID == "2112") || (SessionInfo.CurrentFunctionID == "2113") || (SessionInfo.CurrentFunctionID == "2199"))
        {
            ExportPDFButton.Visible = true;
            ExportExcelButton.Visible = false;
        }
        else if ((SessionInfo.CurrentFunctionID == "1145") || (SessionInfo.CurrentFunctionID == "1146") || (SessionInfo.CurrentFunctionID == "1115") || (SessionInfo.CurrentFunctionID == "1116") || (SessionInfo.CurrentFunctionID == "1117") || (SessionInfo.CurrentFunctionID == "1128") || (SessionInfo.CurrentFunctionID == "1143"))
        {
            ExportPDFButton.Visible = true;
            ExportExcelButton.Visible = false;
        }
        else if ((SessionInfo.CurrentFunctionID == "3104") || (SessionInfo.CurrentFunctionID == "3105") || (SessionInfo.CurrentFunctionID == "3106") || (SessionInfo.CurrentFunctionID == "3107"))
        {
            ExportPDFButton.Visible = true;
            ExportExcelButton.Visible = false;
        }
        else if ((SessionInfo.CurrentFunctionID == "4102") || (SessionInfo.CurrentFunctionID == "4103") || (SessionInfo.CurrentFunctionID == "4104") || (SessionInfo.CurrentFunctionID == "4105") || (SessionInfo.CurrentFunctionID == "4109") || (SessionInfo.CurrentFunctionID == "4110") || (SessionInfo.CurrentFunctionID == "4114") || (SessionInfo.CurrentFunctionID == "4115"))
        {
            ExportPDFButton.Visible = true;
            ExportExcelButton.Visible = false;
        }
        else if (SessionInfo.CurrentFunctionID == "1148" || SessionInfo.CurrentFunctionID == "3109")
        {
            SearchButton.Visible = false;
            ExportPDFButton.Visible = false;
            ExportExcelButton.Visible = true;
        }
        //else if ((SessionInfo.CurrentFunctionID == "2106") || (SessionInfo.CurrentFunctionID == "2107"))
        //{
        //    ExportPDFButton.Visible = false;
        //    ExportExcelButton.Visible = true;
        //    //xExcelxls.Visible = true;
        //}
        else
        {
            ExportPDFButton.Visible = false;
