...
public partial class Control_AC05ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["AC05CrystalReportPath"].ToString();
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "AC05_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
