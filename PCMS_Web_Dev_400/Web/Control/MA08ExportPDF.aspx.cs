...
public partial class Control_MA08ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["MA08CrystalReportPath"].ToString();
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA08_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
