        ...
        if (!Page.IsPostBack)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                try
                {
                    ...
                    xlApp.Cells[CurRow, 1] = "Project Code";
                    xlApp.Cells[CurRow, 2] = "Ledger";
                    xlApp.Cells[CurRow, 3] = "Co Name";
                    xlApp.Cells[CurRow, 4] = "Report Month";
                    xlApp.Cells[CurRow, 5] = "Booked Cost To Date";
                    xlApp.Cells[CurRow + 1, 5] = "(a)";
                    xlApp.Cells[CurRow, 6] = "Cost Accrual";
                    xlApp.Cells[CurRow + 1, 6] = "(b)";
                    xlApp.Cells[CurRow, 7] = "OS_CC";
                    xlApp.Cells[CurRow + 1, 7] = "(c)";
                    xlApp.Cells[CurRow, 8] = "Total Cost To Date (with OS_CC)";
                    xlApp.Cells[CurRow + 1, 8] = "(a)+(b)+(c)";
                    xlApp.Cells[CurRow, 9] = "Total Cost To Date (without OS_CC)";
                    xlApp.Cells[CurRow + 1, 9] = "(a)+(b)";
                    xlApp.Cells[CurRow, 10] = "Gross Income To Date";
                    xlApp.Cells[CurRow + 1, 10] = "(d)";
                    xlApp.Cells[CurRow, 11] = "Income Accrual";
                    xlApp.Cells[CurRow + 1, 11] = "(e)";
                    xlApp.Cells[CurRow, 12] = "Total Income To Date";
                    xlApp.Cells[CurRow + 1, 12] = "(d)+(e)";
                    xlApp.Cells[CurRow, 13] = "Final Income";
                    xlApp.Cells[CurRow + 1, 13] = "(f)";
                    xlApp.Cells[CurRow, 14] = "Final Cost";
                    xlApp.Cells[CurRow + 1, 14] = "(g)";
                    xlApp.Cells[CurRow, 15] = "Final Margin";
                    xlApp.Cells[CurRow + 1, 15] = "(h)";
                    xlApp.Cells[CurRow, 16] = "Anticipated Completion";
                    xlApp.Cells[CurRow + 1, 16] = "(i)";


                    ((Range)ws.Cells[CurRow + 1, 5]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 6]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 7]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 8]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 9]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 10]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 11]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 12]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 13]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 14]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 15]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ((Range)ws.Cells[CurRow + 1, 16]).HorizontalAlignment = XlHAlign.xlHAlignCenter;
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        xlApp.Cells[CurRow, 4] = Convert.ToDateTime(dt.Rows[i]["ReportPeriod"].ToString()).ToString("yyyy-MM-dd");               //D
                        ...
                        xlApp.Cells[CurRow, 16] = Convert.ToDateTime(dt.Rows[i]["AntCompDate"].ToString()).ToString("yyyy-MM-dd");                //P
                    ...
                    //set column width
                    ws.Columns.AutoFit();
                    ((Range)ws.Cells[1, 1]).EntireColumn.ColumnWidth = 15;
                    ((Range)ws.Cells[1, 2]).EntireColumn.ColumnWidth = 15;
                    ((Range)ws.Cells[1, 3]).EntireColumn.ColumnWidth = 15;

                    ws.get_Range("A5", "C" + CurRow).AutoFilter(1, Type.Missing, XlAutoFilterOperator.xlAnd, Type.Missing, true);
