...
public partial class Control_MA04ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string section = Request.QueryString["SDCode"].ToString();

        ReportDocument objRpt = new ReportDocument();
        string reportPath = ConfigurationManager.AppSettings["MA04CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(0, section);
        objRpt.SetParameterValue(1, docDate);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA04_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
