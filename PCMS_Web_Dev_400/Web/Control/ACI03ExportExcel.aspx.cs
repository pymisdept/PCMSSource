...
public partial class Control_ACI03ExportExcel : System.Web.UI.Page
{
    ...
    protected void ExportButton_Click(object sender, EventArgs e)
    {
        ...
        if (String.IsNullOrEmpty(TransType.Text) == true)
        {
            Error_Label.Text = "Transaction Type can not be blank";
            return;
        }
        ...
        bool isTypeValid = TransType.Text.ToUpper() == "A" || TransType.Text.ToUpper() == "C" || TransType.Text.ToUpper() == "D" || TransType.Text.ToUpper() == "M" || TransType.Text.ToUpper() == "S";
        if (!isTypeValid)
        {
            Error_Label.Text = "Please enter a valid transaction type";
            return;
        }
        ...
        if (!String.IsNullOrEmpty(Request.QueryString["ProjectCode"]) && !String.IsNullOrEmpty(Request.QueryString["UserID"])
           ...
           && !String.IsNullOrEmpty(TransType.Text)
           )
        {
            ...
            double cost_code_total = 0;
            double report_code_total = 0;

            int BeforeTotalRow = 0;
            int BeforeReportCodeRow = 0;
            ...
            try
            {
                ...
                Boolean Print3Header = false;
                Boolean Print4Header = false;

                Boolean Print3Total = false;
                Boolean Print4Total = false;
                ...
                oWB = (Microsoft.Office.Interop.Excel.Workbook)(oXL.Workbooks.Add(Type.Missing));
                ...
                oRng = oSheet.get_Range("H6", "N65536");
                //oRng.Font.Name = "Times New Roman";
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    try
                    {
                        ...
                        TempStoreStr = TempStoreStr + "GroupLevel				nvarchar(2),";
                        TempStoreStr = TempStoreStr + "SortLevel1               int,";
                        ...
                        TempStoreStr = TempStoreStr + "AC_PERIOD				nvarchar(8), ";
                        TempStoreStr = TempStoreStr + "Group_CostType			nvarchar(8), ";
                        TempStoreStr = TempStoreStr + "Group_CostTypeDesc		nvarchar(30), ";
                        TempStoreStr = TempStoreStr + "Group_ReportCode		    nvarchar(8), ";
                        TempStoreStr = TempStoreStr + "Group_ReportCodeName	    nvarchar(30), ";
                        TempStoreStr = TempStoreStr + "Group_amount			    numeric(26,6), ";
                        TempStoreStr = TempStoreStr + "TransType				nvarchar(1),";
                        TempStoreStr = TempStoreStr + "Quantity				    numeric(19,6),";
                        TempStoreStr = TempStoreStr + "UnitPrice				numeric(19,6),";
                        TempStoreStr = TempStoreStr + "DocCur				    nvarchar(5)";
                        TempStoreStr = TempStoreStr + ")";
                        ...
                        TempStoreStr = "INSERT INTO #TR_Rpt exec sp_AC03_Detail_New '" + Request.QueryString["ProjectCode"].ToString().Replace("?mode=New", "").Replace("?mode=New&", "").Replace("?mode=", "");
                        ...
                        TempStoreStr = TempStoreStr + "','" + TransType.Text + "'";
                        ...
                        /*
                        TempStoreStr = "select z.SortLevel1, z.PrjCode, z.PrjName, z.CostCode, z.CostCodeDesc, z.U_ReportCode, z.CostType, z.CostTypeDesc, z.TrxDate, z.TrxType, z.Ref, z.BatchNo, z.VoucherNo, z.amount, z.AC_PERIOD, z.orderitem, z.TransType";
                        TempStoreStr = TempStoreStr + " from ( ";
                        TempStoreStr = TempStoreStr + " select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, TrxDate, TrxType, Ref, BatchNo, VoucherNo, amount, AC_PERIOD, 1 as orderitem, TransType";
                        ...
                        TempStoreStr = TempStoreStr + " select '' as SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, '' as TrxDate, '' as TrxType, '' as Ref, '' as BatchNo, '' as VoucherNo, sum(amount), '' as AC_PERIOD, 2 as orderitem, '' as TransType";
                        //TempStoreStr = TempStoreStr + " FROM #TR_Rpt group by CostCode,CostCodeDesc ";
                        TempStoreStr = TempStoreStr + " FROM #TR_Rpt where (SortLevel1 = 1 OR SortLevel1 = 2) group by CostCode,CostCodeDesc, PrjCode, PrjName, U_ReportCode, CostType, CostTypeDesc ";
                        TempStoreStr = TempStoreStr + " ) as z order by z.CostCode, z.orderitem, z.TrxDate";
                        */

                        TempStoreStr = "select z.SortLevel1, z.PrjCode, z.PrjName, z.CostCode, z.CostCodeDesc, z.U_ReportCode, z.CostType, z.CostTypeDesc, z.TrxDate, z.TrxType, z.Ref, z.BatchNo, z.VoucherNo, z.amount, z.AC_PERIOD, z.orderitem, z.TransType, z.Group_CostType, z.Group_CostTypeDesc, z.Group_ReportCode, z.Group_ReportCodeName, z.Group_amount, z.Quantity, z.UnitPrice, z.DocCur ";
                        TempStoreStr = TempStoreStr + "from (  ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, TrxDate, TrxType, Ref, BatchNo, VoucherNo, amount, AC_PERIOD, 1 as orderitem, TransType, Group_CostType, Group_CostTypeDesc, Group_ReportCode, Group_ReportCodeName, Group_amount, Quantity, UnitPrice, DocCur ";
                        TempStoreStr = TempStoreStr + "FROM #TR_Rpt ";
                        TempStoreStr = TempStoreStr + "union all ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, '' as TrxDate, '' as TrxType, '' as Ref, '' as BatchNo, '' as VoucherNo, sum(amount), '' as AC_PERIOD, 2 as orderitem, '' as TransType, '' as Group_CostType, '' as Group_CostTypeDesc, '' as Group_ReportCode, '' as Group_ReportCodeName, 0 as Group_amount, 0 as Group_quantity, 0 as Group_UnitPrice, DocCur  ";
                        TempStoreStr = TempStoreStr + "FROM #TR_Rpt where (SortLevel1 = 1 OR SortLevel1 = 2) group by SortLevel1, CostCode, CostCodeDesc, PrjCode, PrjName, U_ReportCode, CostType, CostTypeDesc, DocCur ";
                        TempStoreStr = TempStoreStr + ") as z order by z.SortLevel1, z.CostCode, z.orderitem, z.TrxDate ";
                        ...
                        */
                        ...
                        oSheet.Cells[Project_Row, 9] = "Base Currency: ";
          ...
          AC_PERIOD
                                ...
                                if (datareader.HasRows == true)
                                {
                                    if (StartRow == true)
                                    {
                                        ...
                                        for (int i = 0; i < datareader.FieldCount; i++)
                                        {
                                            ...
                                            if (datareader.GetName(i) == "TransType")
                                            {
                                                oSheet.Cells[intRow, 12] = "Transaction Type";
                                            }

                                            if (datareader.GetName(i) == "Quantity")
                                            {
                                                oSheet.Cells[intRow, 13] = "Quantity";
                                            }

                                            if (datareader.GetName(i) == "UnitPrice")
                                            {
                                                oSheet.Cells[intRow, 14] = "UnitPrice";
                                            }

                                            Excel.Border border5 = oSheet.get_Range("A" + intRow.ToString(), "N" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                            border5.LineStyle = Excel.XlLineStyle.xlContinuous;
                                            //***********************
                                        }
                                        oSheet.get_Range("A" + intRow.ToString(), "N" + intRow.ToString()).Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Blue);
                                        intRow = intRow + 1;
                                    }
                                    if (datareader["CostCode"] != System.DBNull.Value && datareader["CostCode"].ToString() != "")
                                    {
                                        //Subtotal
                                        ...
                                        if (datareader["DocCur"] != System.DBNull.Value)
                                        {
                                            oSheet.Cells[Project_Row, 9] = "Base Currency: " + datareader["DocCur"].ToString();
                                        }
                                        //}
                                        if (datareader["orderitem"].ToString() == "1")
                                        {
                                            ...
                                            if (datareader["TransType"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 12] = datareader["TransType"].ToString();
                                            }

                                            if (datareader["Quantity"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 13] = datareader["Quantity"].ToString();
                                                oSheet.get_Range("M" + intRow.ToString(), "M" + intRow.ToString()).NumberFormat = "#,##0.00_);(#,##0.00)";
                                            }

                                            if (datareader["UnitPrice"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 14] = datareader["UnitPrice"].ToString();
                                                oSheet.get_Range("N" + intRow.ToString(), "N" + intRow.ToString()).NumberFormat = "#,##0.00_);(#,##0.00)";
                                            }
                                        }
                                    }
                                    else if(datareader["CostCode"].ToString() == "")
                                    {
                                        if (!PrintTotal)
                                        {
                                            // Whole Total
                                            ...
                                            PrintTotal = true;
                                            BeforeTotalRow = intRow;

                                            intRow = intRow + 2;
                                        }

                                        #region Print Groupped Cost Code
                                        if (datareader["SortLevel1"].ToString() == "3")
                                        {
                                            if (!Print3Header)
                                            {
                                                Excel.Border border;
                                            ...
                                            if (datareader["Group_CostType"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 3] = datareader["Group_CostType"].ToString();
                                                oRng = oSheet.get_Range("C" + intRow.ToString(), "C" + intRow.ToString());
                                                oRng.Font.Name = "Times New Roman";
                                                oRng.Font.Size = 12;
                                            }
                                            if (datareader["Group_CostTypeDesc"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 6] = datareader["Group_CostTypeDesc"].ToString();
                                                oRng = oSheet.get_Range("F" + intRow.ToString(), "F" + intRow.ToString());
                                                oRng.Font.Name = "Times New Roman";
                                                oRng.Font.Size = 12;
                                            }
                                            if (datareader["Group_amount"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 8] = datareader["Group_amount"].ToString();
                                                ...
                                                cost_code_total = cost_code_total + Convert.ToDouble(datareader["Group_amount"].ToString());
                                            }
                                        }
                                        #endregion

                                        #region Print Groupped Report Code
                                        if (datareader["SortLevel1"].ToString() == "4")
                                        {
                                            #region Print Cost Total
                                            if (Print3Header && !Print3Total)
                                            {
                                                string temp18;
                                                Excel.Border border18, border19;
                                                oSheet.Cells[intRow, 8] = cost_code_total.ToString();
                                                ...
                                                temp18 = "H" + intRow.ToString();
                                                border18 = oSheet.get_Range(temp18, temp18).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                                border18.LineStyle = Excel.XlLineStyle.xlDouble;
                                                border19 = oSheet.get_Range(temp18, temp18).Borders[Excel.XlBordersIndex.xlEdgeTop];
                                            ...
                                            #region Print Header 4
                                            if (!Print4Header)
                                            {
                                                Excel.Border border2;
                                                string temp2;
                                                ...
                                                #region Report Code Description
                                                ...
                                                border2 = oSheet.get_Range("H" + intRow.ToString(), "H" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                                border2.LineStyle = Excel.XlLineStyle.xlContinuous;
                                                border2 = oSheet.get_Range("F" + intRow.ToString(), "F" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                                border2.LineStyle = Excel.XlLineStyle.xlContinuous;
                                                border2 = oSheet.get_Range("C" + intRow.ToString(), "C" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                                border2.LineStyle = Excel.XlLineStyle.xlContinuous;
                                                border2 = oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                                                border2.LineStyle = Excel.XlLineStyle.xlContinuous;
                                            ...
                                            if (datareader["Group_ReportCode"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 3] = datareader["Group_ReportCode"].ToString();
                                                oRng = oSheet.get_Range("C" + intRow.ToString(), "C" + intRow.ToString());
                                                oRng.Font.Name = "Times New Roman";
                                                oRng.Font.Size = 12;
                                            }
                                            if (datareader["Group_ReportCodeName"] != System.DBNull.Value)
                                            {
                                                oSheet.Cells[intRow, 6] = datareader["Group_ReportCodeName"].ToString();
                                                oRng = oSheet.get_Range("F" + intRow.ToString(), "F" + intRow.ToString());
                                                oRng.Font.Name = "Times New Roman";
                                                oRng.Font.Size = 12;
                                            }
                                            if (datareader["Group_amount"] != System.DBNull.Value)
                                            {
                                                ...
                                                int toRow = BeforeTotalRow - 1;

                                                if (datareader["Group_ReportCode"].ToString() == "CC")
                                                    oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=+SUMIF($D$5:$D$" + toRow.ToString() + ",C" + intRow.ToString() + ",$K$5:$K$" + toRow.ToString() + ")";
                                                else if (datareader["Group_ReportCode"].ToString() == "RMP")
                                                    oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=+SUMIF($D$5:$D$" + toRow.ToString() + ",C" + intRow.ToString() + ",$K$5:$K$" + toRow.ToString() + ")";
                                                else if (datareader["Group_ReportCode"].ToString() == "GC")
                                                    oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=+SUMIF($D$5:$D$" + toRow.ToString() + ",C" + intRow.ToString() + ",$K$5:$K$" + toRow.ToString() + ")";
                                                else
                                                    oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=+SUMIF($C$5:$C$" + toRow.ToString() + ",C" + intRow.ToString() + ",$K$5:$K$" + toRow.ToString() + ")";
                                                
                                                report_code_total = report_code_total + Convert.ToDouble(datareader["Group_amount"].ToString());
                                            }
                                        }
                                        #endregion
                                    }
                        ...
                        #region Print Report Code Total
                        if (Print4Header && !Print4Total)
                        {
                            string temp19, temp20;
                            Excel.Border border20, border21, border22, border23;

                            oSheet.Cells[intRow, 8] = report_code_total.ToString();
                            oSheet.get_Range("K" + intRow.ToString(), "K" + intRow.ToString()).Formula = "=SUM($K$" + (BeforeReportCodeRow + 1).ToString() + ":$K$" + (intRow - 1).ToString() + ")";
                            ...
                            temp19 = "H" + intRow.ToString();
                            border20 = oSheet.get_Range(temp19, temp19).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                            border20.LineStyle = Excel.XlLineStyle.xlDouble;
                            border21 = oSheet.get_Range(temp19, temp19).Borders[Excel.XlBordersIndex.xlEdgeTop];
                            border21.LineStyle = Excel.XlLineStyle.xlContinuous;

                            temp20 = "K" + intRow.ToString();
                            border22 = oSheet.get_Range(temp20, temp20).Borders[Excel.XlBordersIndex.xlEdgeBottom];
                            border22.LineStyle = Excel.XlLineStyle.xlDouble;
                            border23 = oSheet.get_Range(temp20, temp20).Borders[Excel.XlBordersIndex.xlEdgeTop];
                            border23.LineStyle = Excel.XlLineStyle.xlContinuous;
                        ...
                        oSheet.get_Range("A5", "N5").AutoFilter(5, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, true);
                        ...
                        //oSheet.get_Range("L5", "L5").AutoFilter(5, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, true);
                        //oSheet.get_Range("M5", "M5").AutoFilter(5, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, true);
                        //oSheet.get_Range("N5", "N5").AutoFilter(5, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, true);

                        oRng = oSheet.get_Range("A1", "N65536");
                        oRng.EntireColumn.AutoFit();

                        //oSheet.get_Range("A5", "L5").AutoFit();
                        /*
                    ...
                    ((Excel.Range)oSheet.Columns["A", Missing]).ColumnWidth = 19.4;
                    ...
                    ((Excel.Range)oSheet.Columns["L", Missing]).ColumnWidth = 16.5;
                    ((Excel.Range)oSheet.Columns["M", Missing]).ColumnWidth = 17;
                    ((Excel.Range)oSheet.Columns["N", Missing]).ColumnWidth = 17;
