...
public partial class Control_QS22ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
            ...
            string reportPath = ConfigurationManager.AppSettings["QS22CrystalReportPath"].ToString();
 ...
 //           objRpt.ExportToDisk(ExportFormatType.PortableDocFormat, "QS13" + DateTime.Now.ToString("yyyyMMdd"));
            objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "QS22_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
