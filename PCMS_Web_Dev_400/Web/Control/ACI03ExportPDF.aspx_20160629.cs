...
public partial class Control_ACI03ExportPDF : System.Web.UI.Page
{
    ...
    protected void ExportButton_Click(object sender, EventArgs e)
    {
            ...
            )
        {
            ...
            objRpt.SetParameterValue(5, Request.QueryString["UserID"].ToString().Replace("?mode=New", "").Replace("?mode=New&", "").Replace("?mode=", ""));
            objRpt.SetParameterValue(6, projValue.Replace("?mode=New", "").Replace("?mode=New&", "").Replace("?mode=", ""));
