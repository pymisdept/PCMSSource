...
public partial class MasterForm : MasterBasePage, IErrorHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SessionInfo.CurrentFunctionID == "1002")
            lblCancelBQMsg.Visible = true;
        else
            lblCancelBQMsg.Visible = false;
    }
    ...
    public static string CheckForm(UpdateLoadFile UpdateLoad,FormModes FormMode)
    {
        ...
        if (FormMode == MasterForm.FormModes.New)
        {
            ...
            else
            {
                ...
                //if (UpdateLoad.UploadFile[0].ContentType != "application/vnd.ms-excel")
                    if (UpdateLoad.UploadFile[0].ContentType != "application/vnd.ms-excel.sheet.macroEnabled.12" && UpdateLoad.UploadFile[0].ContentType != "application/vnd.ms-excel")
                {
