                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    try
                    {
                        ...
                        */
                        ...
                        TempStoreStr = "select z.SortLevel1, z.PrjCode, z.PrjName, z.CostCode, z.CostCodeDesc, z.U_ReportCode, z.CostType, z.CostTypeDesc, z.TrxDate, z.TrxType, z.Ref, z.BatchNo, z.VoucherNo, z.amount, z.AC_PERIOD, z.orderitem, z.TransType, z.Group_CostType, z.Group_CostTypeDesc, z.Group_ReportCode, z.Group_ReportCodeName, z.Group_amount, z.Quantity, z.UnitPrice ";
                        TempStoreStr = TempStoreStr + "from (  ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, TrxDate, TrxType, Ref, BatchNo, VoucherNo, amount, AC_PERIOD, 1 as orderitem, TransType, Group_CostType, Group_CostTypeDesc, Group_ReportCode, Group_ReportCodeName, Group_amount, Quantity, UnitPrice ";
                        TempStoreStr = TempStoreStr + "FROM #TR_Rpt ";
                        TempStoreStr = TempStoreStr + "union all ";
                        TempStoreStr = TempStoreStr + "select SortLevel1, PrjCode, PrjName, CostCode, CostCodeDesc, U_ReportCode, CostType, CostTypeDesc, '' as TrxDate, '' as TrxType, '' as Ref, '' as BatchNo, '' as VoucherNo, sum(amount), '' as AC_PERIOD, 2 as orderitem, '' as TransType, '' as Group_CostType, '' as Group_CostTypeDesc, '' as Group_ReportCode, '' as Group_ReportCodeName, 0 as Group_amount, 0 as Group_quantity, 0 as Group_UnitPrice ";
                        TempStoreStr = TempStoreStr + "FROM #TR_Rpt where (SortLevel1 = 1 OR SortLevel1 = 2) group by SortLevel1, CostCode, CostCodeDesc, PrjCode, PrjName, U_ReportCode, CostType, CostTypeDesc ";
