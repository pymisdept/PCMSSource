<%@ Page Language="C#" MasterPageFile="~/Control/ExportMasterForm.master" AutoEventWireup="true"
    CodeFile="MA08_ExportWindow.aspx.cs" Inherits="MA08_ExportWindow" %>

<%@ MasterType VirtualPath="~/Control/ExportMasterForm.master" %>
...
%>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" height="60px">
        ...
        <tr>
            <td>
                <PC:Label LabelStyle="xLabel" ID="Label1" runat="server" Text="<%$ Resources:Labels,Works %>" />
            </td>
            <td>
                :
            </td>
