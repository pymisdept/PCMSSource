...
public partial class ScAuditLog : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        gvData.HeaderDescriptions = "ID" + "," + Resources.Labels.LoginName + "," + Resources.Labels.AccessTime + "," + Resources.Labels.Action + "," + Resources.Labels.Function + "," + Resources.Labels.TableName + "," + Resources.Labels.IpAddress + "," + Resources.Labels.Project;
    ...
    protected void OnInitDropDownListRegion()
    {
        ...
        PCDb.InitDropDownList(this.ddlModule, "sc_module", "ID", "ModuleValue", Consts.DropDownOptionAll, null, null, " SHOWORDER ");
    ...
    protected void SetDataSource()
    {
        StringBuilder sb = new StringBuilder(String.Format("select ID,LOGINNAME,convert(varchar(10),logtime,120)+' '+left(convert(varchar(10),logtime,108),5) as LOGTIME,"+
            "ACTION,FUNCNAME,TABLENAME,IPADDRESS,ProjectCode from {0} where 1=1  ", VIEW_NAME));
        Db db = PCDb.Db;
        ...
        gvData.HiddenFields = "IPADDRESS,ID,MODULE";
        gvData.HeaderDescriptions = "ID" + "," + Resources.Labels.LoginName + "," + Resources.Labels.AccessTime + "," + Resources.Labels.Action + "," + Resources.Labels.Function + "," + Resources.Labels.TableName + "," + Resources.Labels.IpAddress + "," + Resources.Labels.Project;
    }
    ...
    void ExportRecord()
    {
        ...
        string hidFiled = "ID";
        string header = "ID" + "," + Resources.Labels.LoginName + "," + Resources.Labels.AccessTime + "," + Resources.Labels.Action + "," + Resources.Labels.Function + "," + Resources.Labels.TableName + "," + Resources.Labels.IpAddress + "," + Resources.Labels.Project + "," + Resources.Labels.Remarks;
    ...
    {
        StringBuilder sb = new StringBuilder(String.Format("select ID,LOGINNAME,LOGTIME,ACTION,FUNCNAME,TABLENAME,IPADDRESS,ProjectCode from {0} where 1=1  ", VIEW_NAME));
        Db db = PCDb.Db;
        ...
        dsGridView.ErrorHandler = this.Master;
        gvData.HiddenFields = "ID,TABLENAME";
        gvData.HeaderDescriptions = "ID" + "," + Resources.Labels.LoginName + "," + Resources.Labels.AccessTime + "," + Resources.Labels.Action + "," + Resources.Labels.Function + "," + Resources.Labels.TableName + "," + Resources.Labels.IpAddress + "," + Resources.Labels.Project + "," + Resources.Labels.Remark;
