<%@ Page Language="C#" MasterPageFile="~/Control/MasterBase.master" AutoEventWireup="true"
    CodeFile="NotExistPage.aspx.cs" Inherits="NotExistPage" Title="Untitled Page" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="Errortitletxt" style="padding-bottom: 40px">
                                            <asp:Literal ID="Literal1" runat ="server"  Text="<%$ Resources:Messages,Error %>" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><asp:Literal ID="Literal2" runat ="server"   Text="<%$ Resources:Messages,PageNotExist %>" /></p>
                                            <p><a href ="javascript:history.back();"><asp:Literal ID="Literal3" runat ="server"   Text="<%$ Resources:Messages,Back %>" /></a></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
