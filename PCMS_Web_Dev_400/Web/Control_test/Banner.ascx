                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="right" valign="bottom" style ="padding-right:20px;" >
                                    ...
                                    <tr>
                                        <!-- Updated by Ken on 20170704, begin 
                                        ...
                                        <td><a href="javascript:JumpLang('zh-cn');" class="languagetxt">&#31616;&#20307;</a></td>
                                         -->
                                         <td><img src="<%=themeUrl%>/images/linewhite.gif" width="20" height="20"></td>
                                        <td><a href="/pcms_share/PCMS_User_Guide(QS).pdf" style="color: white; text-decoration: none;" target="_blank">User Guide</a></td>
                                        <%--<td><img src="<%=themeUrl%>/images/linewhite.gif" width="23" height="23"></td>--%>
