<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ACI08ExportExcel.aspx.cs" Inherits="Control_ACI03ExportExcel" UICulture="UK" Culture="en-GB"  %>
...
<body>
    ...
    <tr>
	 ...
	 <tr>
        <td>
            <asp:Label ID="Label4" runat="server" Text="Current Period"></asp:Label>
        </td>
        <td>
