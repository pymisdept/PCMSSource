...
public partial class Control_MA12ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["MA12CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(2, docEntry);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA12_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
