...
public partial class Control_PU07ExportExcel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            ws.Cells[1, 1] = "MATERIAL ORDER LIST (Agreement) in HK$";
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                try
                {
                    ...
                    ((Range)ws.Cells[1, 4]).EntireColumn.ColumnWidth = 8;
                    ((Range)ws.Cells[1, 5]).EntireColumn.ColumnWidth = 30;
                    ((Range)ws.Cells[1, 6]).EntireColumn.ColumnWidth = 0;
                    ...
                    ((Range)ws.Cells[1, 17]).EntireColumn.ColumnWidth = 0;
