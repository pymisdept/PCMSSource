...
public partial class Control_MA06ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["MA06CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(0, docEntry);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA06_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
