...
public partial class Control_MA10ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["MA10CrystalReportPath"].ToString();
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA10_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
