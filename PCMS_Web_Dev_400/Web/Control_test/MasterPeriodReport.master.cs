            ...
            case DataControlRowType.DataRow:
                ...
                try
                {
                                ...
                                && e.Row.Cells[13].Text != Consts.DOCUMENT_DRAFT_PENDING)
                    {
                        ...
                        e.Row.Cells[12].Text += "&nbsp;|&nbsp;";
                        e.Row.Cells[12].Text += "<a href='javascript:ExportReport(" + e.Row.Cells[0].Text + ",\"" + _duedate.ToString("yyyy-MM-dd") + "\",\"" + SessionInfo.UserName.ToString() + "\");'>" + Resources.Labels.PDF + "</a>";
