...
public partial class Control_PU11ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["PU11CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(0, prjCode);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "PU11_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
