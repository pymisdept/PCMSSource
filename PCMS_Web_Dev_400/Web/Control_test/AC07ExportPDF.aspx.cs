...
public partial class Control_AC07ExportPDF : System.Web.UI.Page
{
    ...
    {
        string endDate = Request.QueryString["DocDate"].ToString();
        string userID = Request.QueryString["UserName"].ToString();

        ReportDocument objRpt = new ReportDocument();
        string reportPath = ConfigurationManager.AppSettings["AC07CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(0, endDate);
        objRpt.SetParameterValue(1, userID);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "AC07_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
