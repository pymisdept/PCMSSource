...
public partial class Control_PU13ExportPDF : System.Web.UI.Page
{
    ...
    {
        string prjCode = Request.QueryString["ProjectCode"].ToString();
        string userID = Request.QueryString["UserName"].ToString();
        string cutOffDate = Request.QueryString["DocDate"].ToString();

        ReportDocument objRpt = new ReportDocument();
        string reportPath = ConfigurationManager.AppSettings["PU13CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(2, cutOffDate);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "PU13_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
