...
public partial class Control_MA13ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["MA13CrystalReportPath"].ToString();
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "MA13_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
