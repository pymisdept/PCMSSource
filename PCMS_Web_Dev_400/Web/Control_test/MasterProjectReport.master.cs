...
public partial class MasterProjectReport : MasterBasePage, IErrorHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if(SessionInfo.CurrentFunctionID == "3109")
        {
            ...
            {
                SAPDb.InitDropDownList(ddlProject, "CPS_View_UserLedgerAll", "CompanyCode", "CompanyName", Consts.DropDownOptionAll, null, null);
            }
            else
            {
                SAPDb.InitDropDownList(ddlProject, "CPS_View_UserLedger", "CompanyCode", "CompanyName", Consts.DropDownOptionAll, null, string.Format(" LOGINNAME =('{0}')", SessionInfo.LoginName.ToUpper()));
            }
        }
