...
public partial class Control_QS28ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string period = Request.QueryString["DocDate"].ToString();

        ReportDocument objRpt = new ReportDocument();
        string reportPath = ConfigurationManager.AppSettings["QS28CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(2, prjCode);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "QS28_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
