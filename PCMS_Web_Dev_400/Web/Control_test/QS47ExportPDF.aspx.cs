...
public partial class Control_QS47ExportPDF : System.Web.UI.Page
{
    ...
    protected void doExport()
    {
        ...
        string reportPath = ConfigurationManager.AppSettings["QS47CrystalReportPath"].ToString();
        ...
        objRpt.SetParameterValue(2, startDate);
        objRpt.SetParameterValue(3, endDate);
        ...
        objRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, this.Page.Response, true, "QS47_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
