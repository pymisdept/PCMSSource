...
namespace PCCore
{
    ...
    public class SearchGridView : SimpleGridView
    {
        ...
        public SearchGridView()
        {
            ...
            PCCore.Common.HRLog.RecordLog(SessionInfo.CurrentFunction.ToUpper());
            this.PageSize = _pagesize;
            //Disable Double Click


            base.ClientRowDblClicked = "if(typeof(selectValue)=='function') selectValue();";
        ...
        /// <summary>
        /// ÉèÖÃÊÇ·ñ×Ô¼º±¾Ò³ÓÐµ¼³öµÄ¹¦ÄÜ²Ù×÷¡£ 2006-11-16
        /// </summary>
        ...
        /// <summary>
        /// ÉèÖÃÊÇ·ñÔÊÐíDataRowµÄÖµ¸ù¾Ý ResourcesÀ´¶¨Òå
        /// </summary>
        ...
        /// <summary>
        /// ÉèÖÃÊÇ·ñÔÊÐíDataRowµÄÖµ¸ù¾Ý ÀàÐÍ½øÐÐÄ¬ÈÏµÄ¸ñÊ½»¯
        /// </summary>
        ...
        {
            string fileName = String.Format("exp{0}.xlsx", DateTime.Now.ToString("yyMMddHHmmssfff"));
