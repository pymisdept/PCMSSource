...
namespace PCCore
{
    ...
    public class SearchButton :  System.Web.UI.WebControls.Button    //AspButton
    {
        public SearchButton()
        {
            //事件顺序
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            base.Attributes.Add("onclick", "setCommand(COMMAND_REFRESH); if (typeof(_Refresh)=='function') { if (!_Refresh()) { return false; } } else { if (!Refresh()) return false;}");
            base.Text = "GO";
