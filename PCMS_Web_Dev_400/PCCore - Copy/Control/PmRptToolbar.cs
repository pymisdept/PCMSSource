...
namespace PCCore
{
    ...
    public class PmRptToolBar : WebControl
    {
        ...
        protected bool _buttonBackVisible = true;
        ...
        protected bool _buttonCancelVisible = false;
       ...
       Description("Gets or sets Visible of ViewImport button")]
        ...
        {
            get { return _buttonCancelVisible; }
            set { _buttonCancelVisible = value; }
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            _ibCancel = new ImageButton();
            _ibCancel.CausesValidation = false;
            _ibCancel.ID = Consts.ButtonCancel;
            _ibCancel.ImageUrl = _imageBaseUrl + "/back.gif";
            _ibCancel.ToolTip = HttpContext.GetGlobalResourceObject(Consts.ResourcesCommon, "Cancel").ToString();
            _ibCancel.CssClass = "ToolbarImage";
            _ibCancel.OnClientClick = "if(!Cancel()) return false;";
            _ibCancel.Visible = true;
