...
namespace PCCore
{
    ...
    public class ReportToolBar : WebControl
    {
       ...
       Description("Gets or sets Visible of ViewImport button")]
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (SessionInfo.CurrentModuleID != "6")
                ...
                _ibSave.Visible = true;
            _ibNew.Visible = false;
            //Download Manager Disable Export Function
            PCCore.Common.HRLog.RecordLog(SessionInfo.CurrentFunction);
            PCCore.Common.HRLog.RecordLog(SessionInfo.CurrentFunctionID);
            if (SessionInfo.CurrentFunction.ToLower() != Consts.Function_DownloadManager.ToLower())
                _ibExport.Visible = true;
            else
                _ibExport.Visible = false;
