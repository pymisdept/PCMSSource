...
#Region "Constanst Value"
        Public Const sapObjType As String = "13"
        Public Const TableName As String = "CPS_VIEW_FLEXC"
        '// Public Const TableName As String = "PRE_INV1"
