...
#Region "Constanst Value"
        ...
        Public Const TableName As String = "PRE_OQUT"
...
#Region "Get Filter Information Structure"
        ...
        Public Sub getDocument()
            ...
            sqlStr &= "	           Where	" & vbCrLf
            sqlStr &= "	           " & Datatable.SAP.AR.OQUT_Hdr.TableName & ".DocEntry = [" & Datatable.SAP.Sync_History.TableName & "].DocEntry And 	" & vbCrLf
            sqlStr &= "	           " & Datatable.SAP.AR.OQUT_Hdr.TableName & ".ObjType  = [" & Datatable.SAP.Sync_History.TableName & "].ObjType	" & vbCrLf
            sqlStr &= "	)	" & vbCrLf
            sqlStr &= " AND " & Datatable.SAP.AR.OQUT_Hdr.TableName & ".DocStatus  = 'O'" & vbCrLf
