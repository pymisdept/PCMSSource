...
Namespace Datatable.SAP.AP
    Public Class Supplier_Dtl
        Inherits CPS.SQL.Interface.RecordSet

#Region "Constanst Value"
        Public Const sapObjType As String = "18"
        Public Const TableName As String = "PRE_PCH1"
        ...
        Public Const _StockSum As String = "StockSum"
        ...
        '13 Jun 2010
        'Public Const _U_SourcePCMSDocNum As String = "U_SourcePCMSDocNum"
...
#Region "Get Filter Information Structure"
        ...
        Public Sub getPurchaseInvoice(ByVal pDocEntry As Integer)
            ...
            oCondition.Alias = Supplier_Dtl.DocEntry
            ...
            oCondition.Alias = Supplier_Dtl.ObjType
            oCondition.Operation = Condition.eOperation.op_EQUAL
            oCondition.Value = "18"
