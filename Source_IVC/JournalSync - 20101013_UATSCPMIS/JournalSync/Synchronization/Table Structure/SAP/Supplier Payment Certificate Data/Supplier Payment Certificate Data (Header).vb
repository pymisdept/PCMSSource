...
#Region "Get Filter Information Structure"
        ...
        Public Sub getPurchaseInvoice()
            ...
            sqlStr &= "	           Where	" & vbCrLf
            sqlStr &= "	           " & Datatable.SAP.AP.Supplier_Hdr.TableName & ".DocEntry = [" & Datatable.SAP.Sync_History.TableName & "].DocEntry And 	" & vbCrLf
            sqlStr &= "	           " & Datatable.SAP.AP.Supplier_Hdr.TableName & ".ObjType  = [" & Datatable.SAP.Sync_History.TableName & "].ObjType	" & vbCrLf
            sqlStr &= "	)	" & vbCrLf
