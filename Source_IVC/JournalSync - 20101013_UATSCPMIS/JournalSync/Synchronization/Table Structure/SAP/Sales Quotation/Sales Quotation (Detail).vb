...
#Region "Constanst Value"
        Public Const sapObjType As String = "23"
        Public Const TableName As String = "PRE_QUT1"
        ...
        '// Additional UDF at 20 May 2010
        Public Const _U_ReLineTotal As String = "U_ReLineTotal"
        Public Const _U_ReQuantity As String = "U_ReQuantity"
#End Region
...
#Region "Define New"
        Public Sub New()
            ...
            '// 20 May 2010
            Me.add(_U_ReLineTotal)
            Me.add(_U_ReQuantity)
        End Sub
#End Region
...
#Region "Assign Value"
        ...
        Public WriteOnly Property U_ReLineTotal() As String
            Set(ByVal value As String)
                If Not Me.modify(_U_ReLineTotal, value) Then
                    Throw New BaseException(BaseException.ErrorType.System, CheckPoint, ErrorDescription & " " & "[]")
                End If
            End Set
        End Property

        Public WriteOnly Property U_ReQuantity() As String
            Set(ByVal value As String)
                If Not Me.modify(_U_ReQuantity, value) Then
                    Throw New BaseException(BaseException.ErrorType.System, CheckPoint, ErrorDescription & " " & "[]")
                End If
            End Set
        End Property
