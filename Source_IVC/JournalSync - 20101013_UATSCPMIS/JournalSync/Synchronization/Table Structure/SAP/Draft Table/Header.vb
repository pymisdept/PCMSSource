...
#Region "Define New"
        Public Sub New()
            ...
            Me.getPurchaseInvoice()
        End Sub
#End Region

#Region "Get Filter Information Structure"

        Public Sub getPurchaseInvoice()
            ...
            sqlStr &= "	           " & Header.TableName & ".ObjType  = '18'	And " & vbCrLf
            sqlStr &= "	           " & Header.TableName & ".DocStatus = 'O'	And " & vbCrLf
            sqlStr &= "	           [" & Datatable.SAP.Sync_History.TableName & "].ReasonCode='M112' " & vbCrLf
            sqlStr &= "	)	" & vbCrLf
            ...
            sqlStr &= " and " & Header.TableName & ".U_CertStatus = 'S'"
            'sqlStr &= " and exists (select 1 from IVC_TBL_PCSTATUS T1 Where ODRF.DocEntry = T1.DocEntry and T1.AppStatus = 'A')"
